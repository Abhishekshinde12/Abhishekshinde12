...
#### ☁️ DevOps & Tools
- **Docker**, **Postman**, <!--**VS Code**, **GitHub Actions**,-->
...
#### 🧾 [Expense Tracker API](https://github.com/yourusername/expense-tracker)
...
#### 🎬 [Real-time Audio Emotion Recognition](https://github.com/yourusername/audio-emotion)
> FastAPI-based backend for analyzing live audio streams for emotion classification.
